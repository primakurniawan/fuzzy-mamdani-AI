...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="img/gigi.png" rel="shortcut icon">
...
<body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            <h1>Cegah Lubang</h1>
            <p class="lead">Penilaian risiko gigi berlubang pada balita merupakan opsi yang baik untuk mencegah
                terjadinya pengalaman gigi berlubang, klik tombol di bawah untuk memulai.

            </p>

            <p class="lead">
                <a href="fuzzy2.php" role="button" class="btn btn-primary">Mulai Sekarang</a>
            </p>
