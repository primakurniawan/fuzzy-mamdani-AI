...
<div class="row">
    <div class="col-lg-12">
        ...
        <p> Fuzzy secara bahasa diartikan sebagai kabur atau samar yang artinya suatu
            ...
            bobot keanggotaan yang dimilikinya. </p>
        <br>
        <h2><b>Metode Mamdani</b><br></h2>
        <p> Untuk metode ini, pada setiap aturan yang berbentuk implikasi (“sebab
        ...
        <a href="carakerja.php" class="btn btn-primary btn-lg btn-flat" id="menu-toggle">Berikutnya &#8594;</a>
